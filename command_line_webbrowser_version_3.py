...
binary = FirefoxBinary('/media/kali/F2CC8EAFCC8E6E23/firefox-68.0.1/firefox/firefox')
...
class MyBrowser:
    ...
    def userChoices(self):
        ...
        while 'y' in user_input or 'Y' in user_input:
            ...
            print("These are the Below Options Available to You ...")
            ...
            print('*'*44)
            try:
                ins = int(input("Enter Your Input(From The Above List) : "))
                if ins == 1:
                    self.requestForm()
                elif ins == 2:
                    self.getDetailImg()
                ...
                print("[*] Please Check Your Input You can Input only 1, 2, 3, 4, 5, 6 From The Above List Available to You")
            user_input = str(input("Want to Continue(Either Yes or No) : "))
    ...
    def requestForm(self):
        ...
        try:
            var = int(input("Enter Your Input (Above Options are Available to You (Integer Value Only)): "))
        except Exception as e:
